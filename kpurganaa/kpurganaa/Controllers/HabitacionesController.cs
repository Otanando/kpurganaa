...
namespace kpurganaa.Controllers
{
    public class HabitacionesController : Controller
    {
        ...
        public HabitacionesController(kpurganaaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Habitaciones != null ? 
                          ...
                          Problem("Entity set 'kpurganaaContext.Habitaciones'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdHabitacion,Numerohabitacion,Precio,Capacidad,Estado,Descripcion")] Habitacione habitacione)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdHabitacion,Numerohabitacion,Precio,Capacidad,Estado,Descripcion")] Habitacione habitacione)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'kpurganaaContext.Habitaciones'  is null.");
            }
            var habitacione = await _context.Habitaciones.FindAsync(id);
            if (habitacione != null)
            {
