...
namespace kpurganaa.Controllers
{
    public class PaquetesController : Controller
    {
        ...
        public PaquetesController(kpurganaaContext context)
        {
            _context = context;
        }
        ...
        {
            var kpurganaaContext = _context.Paquetes.Include(p => p.IdHabitacionNavigation).Include(p => p.IdServicioNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdPaquete,IdServicio,IdHabitacion,Nombre,Descripcion,Precio")] Paquete paquete)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPaquete,IdServicio,IdHabitacion,Nombre,Descripcion,Precio")] Paquete paquete)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'kpurganaaContext.Paquetes'  is null.");
            }
            var paquete = await _context.Paquetes.FindAsync(id);
            if (paquete != null)
            {
